...
export const productionArchive: ProductionArchiveItem[] = [
  ...
  },
  {
    ...
    size: "feature",
    note: "Delivered a 48-hour-turnaround music video for PS HITSQUAD, matching the experimental instrumental with glitching, time-displaced masks.",
    tags: ["Direction", "Edit", "Colour grade", "Camera Operator", "Pre-production"],
    link: "https://youtu.be/_ljhYDLuc0g?si=HV3Ph-dgekwQYHb6",
    linkLabel: "Watch full video",
    poster: "/media/archive/gnasher.webp",
    video: "/media/archive/gnasher.mp4"
  },
  {
    id: "archive-05",
    title: "HEN$HAW - MAD",
    ...
    orientation: "landscape",
    size: "standard",
    note: "A passion-led collaboration returning to HEN$HAW’s roots through a London block location and childhood playground.",
    tags: ["Director", "Edit", "Colour grade", "Camera Operator", "Pre-production"],
    link: "https://youtu.be/Opy8g7hdI7k?si=XOO1kheOpLxQt97I",
    linkLabel: "Watch full video",
    poster: "/media/archive/henshaw-mad.webp",
    video: "/media/archive/henshaw-mad.mp4"
  },
  {
    id: "archive-06",
    title: "VFX Breakdown BTS",
    client: "BVDLVD",
    role: "Editor / BTS Producer",
    category: "Post-production",
    orientation: "landscape",
    size: "wide",
    note: "A behind-the-scenes breakdown of a self-funded independent music video, covering the full thought process, planning, location shoot and editing approach.",
    tags: ["Edit", "BTS", "Actors", "Pre-production", "Shot direction"],
    link: "https://www.youtube.com/watch?v=aMv4MpTQmQ0",
    linkLabel: "Watch full breakdown",
    poster: "/media/archive/vfx-breakdown-bts.webp",
    video: "/media/archive/vfx-breakdown-bts.mp4"
  },
  {
    id: "archive-07",
    title: "AISLE 13",
    client: "XANIMA",
    role: "Camera / Editor / Production collaborator",
    category: "Video production",
    orientation: "landscape",
    size: "feature",
    note: "Built a Croatia shoot into the available budget, collaborating with XANIMA on a high-energy music video with stop-motion elements.",
    tags: ["Edit", "Colour grade", "Team collaboration", "Pre-production"],
    link: "https://youtu.be/ST0olYTrK9o?si=pJXZ5sK7hO-Y1u5i",
    linkLabel: "Watch full video",
    poster: "/media/archive/aisle-13.webp",
    video: "/media/archive/aisle-13.mp4"
  },
  {
    id: "archive-08",
    title: "KNOCK KNOCK",
    client: "BVDLVD / XANIMA",
    role: "Director / Editor / Performer",
    category: "Video production",
    orientation: "landscape",
    size: "wide",
    note: "A high-intensity house-party video using SnorriCam, complex lighting and actors. Developed with XANIMA, with performance, direction, editing, colour and instrumental production contributions.",
    tags: ["Edit", "Pre-production", "Sound design", "Direction", "Colour grade"],
    link: "https://youtu.be/zpG-qxqRjKM?si=MK9sibwfLeDFC72e",
    linkLabel: "Watch full video",
